...
#include "triton-shared/Dialect/Util/IR/UtilDialect.h"
#include "triton-shared/Dialect/Util/IR/UtilOps.h"
...
#include "triton-shared/Dialect/Util/IR/UtilEnums.cpp.inc" // IWYU pragma: keep
// clang-format on
...
#include "triton-shared/Dialect/Util/IR/UtilTypes.cpp.inc" // IWYU pragma: keep
// clang-format on

namespace mlir::iree_compiler::IREE::Util {

// At the end so it can use functions above:
#include "triton-shared/Dialect/Util/IR/UtilOpInterfaces.cpp.inc"
#include "triton-shared/Dialect/Util/IR/UtilTypeInterfaces.cpp.inc"
