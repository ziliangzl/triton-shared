...
#include "triton-shared/Dialect/Util/IR/UtilEnums.h.inc" // IWYU pragma: keep
// clang-format on
...
#include "triton-shared/Dialect/Util/IR/UtilAttrInterfaces.h.inc" // IWYU pragma: export
#include "triton-shared/Dialect/Util/IR/UtilOpInterfaces.h.inc" // IWYU pragma: export
#include "triton-shared/Dialect/Util/IR/UtilTypeInterfaces.h.inc" // IWYU pragma: export

// clang-format off: must be included after all LLVM/MLIR headers.
#define GET_ATTRDEF_CLASSES
#include "triton-shared/Dialect/Util/IR/UtilAttrs.h.inc" // IWYU pragma: keep
// clang-format on

// clang-format off: must be included after all LLVM/MLIR headers.
#define GET_TYPEDEF_CLASSES
#include "triton-shared/Dialect/Util/IR/UtilTypes.h.inc" // IWYU pragma: keep
// clang-format on
